...
export function createTrex(): THREE.Group {
  ...
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.4, 0.35), mat);
  ...
  const jaw = new THREE.Mesh(new THREE.BoxGeometry(0.25, 0.08, 0.25), belly);
  jaw.position.set(0.48, 0.58, 0); g.add(jaw);
  const tail = new THREE.Mesh(new THREE.ConeGeometry(0.15, 0.6, 6), mat);
  ...
  g.scale.setScalar(0.45); return g;
}
...
export function createTriceratops(): THREE.Group {
  ...
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.35, 0.4), mat);
  body.position.set(0, 0.45, 0); g.add(body);
  const head = new THREE.Mesh(new THREE.BoxGeometry(0.25, 0.3, 0.35), mat);
...
export function createStegosaurus(): THREE.Group {
  ...
  const tail = new THREE.Mesh(new THREE.ConeGeometry(0.1, 0.5, 6), mat);
...
export function createBrachiosaurus(): THREE.Group {
  ...
  g.scale.setScalar(0.4); return g;
}
...
export function createVelociraptor(): THREE.Group {
  ...
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.35, 0.2, 0.18), mat);
  body.position.set(0, 0.45, 0); g.add(body);
...
export function createAnkylosaurus(): THREE.Group {
  ...
  const head = new THREE.Mesh(new THREE.BoxGeometry(0.18, 0.15, 0.2), mat);
...
export function createParasaurolophus(): THREE.Group {
  ...
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.5, 0.3, 0.3), mat);
  body.position.set(0, 0.45, 0); g.add(body);
